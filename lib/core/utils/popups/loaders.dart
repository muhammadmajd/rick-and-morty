  ...
  ScaffoldMessenger.of(Get.context!).showSnackBar(
      SnackBar(
          ...
          backgroundColor: Colors.transparent,
           content: Container ( padding: const EdgeInsets.all (12.0),
...
static customToastAnimation ({required String message,required String animation}) {
  ScaffoldMessenger.of(Get.context!).showSnackBar(
      SnackBar(
          elevation: 0,
          ...
          content: Container ( padding: const EdgeInsets.all (12.0),
            ...
            child: TAnimationLoaderWidget(text: message, animation: animation),
          )
      )
  );
}
