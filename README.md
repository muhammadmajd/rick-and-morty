...
### 💾 Оффлайн-доступ
- Все данные и изображения кэшируются локально с помощью **Hive** и **CachedNetworkImage**.
- Приложение работает без интернета, отображая сохранённые данные.
...
![Главный экран](assets/screenshots/structure.png)
